...
import { Input, Button, Upload, message as antdMessage, Space, Popover } from 'antd';
import { SendOutlined, DeleteOutlined, SmileOutlined, PictureOutlined, FileOutlined, ClearOutlined } from '@ant-design/icons';
