      ...
      <Dropdown
        overlay={
          <Menu>
            ...
            <Menu.Divider />
            <Menu.Item key="3">更多功能</Menu.Item>
          </Menu>
        }
        trigger={['click']}
      >
  ...
  return (
    <div style={{ padding: '20px', background: '#f5f5f5' }}>
      ...
      <div style={{ marginBottom: '20px' }}>
        <h4>基础自定义快捷按钮</h4>
        <div style={{ background: '#fff', borderRadius: '8px' }}>
          <MessageInput onSend={handleSend} quickActions={basicQuickActions} />
        </div>
      </div>
      ...
      <div style={{ marginBottom: '20px' }}>
        <h4>禁用快捷按钮</h4>
        <div style={{ background: '#fff', borderRadius: '8px' }}>
          <MessageInput onSend={handleSend} showDefaultQuickActions={false} />
        </div>
      </div>
    </div>
  );
