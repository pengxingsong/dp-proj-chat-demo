...
export const mockSessions: SessionItem[] = [
  ...
  },
  {
    ...
    lastMessage: {
      type: 'image',
      content: 'https://via.placeholder.com/40x40.png?text=IMG',
    },
    time: '16:20',
    unread: 1,
    status: 'online',
...
export const mockInitialMessages: CustomMessage[] = [
  ...
  },
  {
    type: 'file',
    fileType: 'pdf',
    url: '/assets/chat/file/[技术] MyBatis 3x.pdf',
  ...
  },
  {
    type: 'file',
    fileType: 'mp3',
    url: '/assets/chat/file/huayao.mp3',
    fileName: 'huayao.mp3',
    timestamp: new Date().toLocaleTimeString(),
    from: 'ai',
  },
  {
    type: 'video',
    url: '/assets/chat/file/test1.mp4',
    fileName: 'test1.mp4',
    timestamp: new Date().toLocaleTimeString(),
    from: 'ai',
  },
  {
    type: 'office',
    fileType: 'doc',
    url: '/assets/chat/file/test1.docx',
    fileName: 'test1.docx',
    timestamp: new Date().toLocaleTimeString(),
    from: 'ai',
  },
  {
    ...
    title: '百度',
    description: '百度',
    image: '/assets/chat/img/image.jpg',
    timestamp: new Date().toLocaleTimeString(),
    from: 'ai',
  },
];
...
export class ChatAPI {
  ...
  static async sendMessage(
    ...
    await delay(500);
    console.log('发送消息:', sessionId, message, files);
  }
